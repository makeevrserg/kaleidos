...
import com.makeevrserg.kaleidos.feature.PreviewFixtures.initialState
...
class PreviewStateReducerTest {
    ...
    fun GIVEN_served_file_WHEN_same_file_is_rescanned_THEN_host_freshness_and_url_are_kept() {
        ...
        assertEquals(
            "http://localhost:8085/kaleidos.html?preview=app.CardPreview,app.DarkCardPreview",
            state.previewUrl
        )
    }
    ...
    fun GIVEN_served_file_WHEN_focus_on_its_preview_THEN_url_gets_fragment() {
        ...
        assertEquals(
            "http://localhost:8085/kaleidos.html?preview=app.CardPreview#app.CardPreview",
            state.previewUrl
        )
    }
    ...
    fun GIVEN_running_server_of_the_files_module_WHEN_host_attached_THEN_url_derived() {
        ...
        assertEquals("http://localhost:8085/kaleidos.html?preview=app.CardPreview", state.previewUrl)
    }
