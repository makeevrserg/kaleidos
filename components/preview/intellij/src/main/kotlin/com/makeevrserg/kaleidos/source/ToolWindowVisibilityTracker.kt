...
import com.makeevrserg.kaleidos.toolwindow.PreviewToolWindowIds
 ...
 *
 * @param mainContext [com.makeevrserg.kaleidos.core.PreviewDispatchers.main]; the tool
...
class ToolWindowVisibilityTracker(
    ...
    private fun visibility(): Flow<Boolean> = callbackFlow {
        ...
        val subscription = Disposer.newDisposable("Kaleidos tool window visibility")
