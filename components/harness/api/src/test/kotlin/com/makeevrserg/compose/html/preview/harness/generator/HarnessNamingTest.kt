...
class HarnessNamingTest {
    ...
    fun GIVEN_gradle_path_with_dashes_WHEN_registry_package_THEN_it_is_a_valid_package() {
        assertEquals(
            "composehtmlpreview.generated.m_components_lib_kobweb_ui",
    ...
    fun GIVEN_root_project_WHEN_registry_package_THEN_the_segment_is_still_an_identifier() {
        assertEquals("composehtmlpreview.generated.m", naming.registryPackage(""))
    }
    ...
    fun GIVEN_two_modules_WHEN_registry_fqn_THEN_the_registries_do_not_collide() {
        ...
        assertEquals("composehtmlpreview.generated.m_components_ui.PreviewRegistry", first)
        assertEquals("composehtmlpreview.generated.m_instances_ui.PreviewRegistry", second)
    }
}
